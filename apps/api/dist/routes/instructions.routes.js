...
async function resolveSchema(tableName, database, posId) {
    const schema = await fetchTableSchemaFromPos(database, tableName, posId);
    return schema.columns;
}
export async function instructionsRoutes(app) {
    app.post('/api/instructions/parse', async (req, reply) => {
    ...
    app.post('/api/instructions/deploy', async (req, reply) => {
